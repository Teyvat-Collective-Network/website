...
<div class="panel">
    ...
    <Show when={open.rolesync}>
        ...
        <Loading done={rolesync}>
            ...
            <p class="text-2">
                For each API condition below, users matching the condition will automatically be assigned the Discord roles listed following it. Only roles that
                the bot can manage can be added.
            </p>
            <div class="col no-center gap-1">
